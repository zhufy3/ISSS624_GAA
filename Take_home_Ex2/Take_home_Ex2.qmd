...
And we will apply different clustering analysis methods to delineate the country based on *ADMIN 2* level with attributes of water points shown above.

## Overview

In this exercise, we will use several clustering analysis ways to deal with geospatial and aspatial data of **Nigeria** case! Let us get started now!
...
schc<-qtm(nga_sf_Gcluster, "CLUSTER")+
   tm_layout(legend.outside = TRUE,
            ...
            legend.position = c("right", "bottom"),
            frame = FALSE, 
            main.title="Spatially Constrained Hierarchical Clustering-ClustGeo",
            main.title.size = .7)
nshc<-qtm(nga_sf_ngeo_cluster, "CLUSTER")+
   tm_layout(legend.outside = TRUE,
            ...
            legend.position = c("right", "bottom"),
            frame = FALSE, 
            main.title ="Non-spatially Constrained Hierarchical Clustering-ClustGeo",
            main.title.size = .7)
...
hc<-qtm(nga_sf_cluster, "CLUSTER" )+
   tm_layout(legend.outside = TRUE,
            ...
            legend.position = c("right", "bottom"),
            frame = FALSE,
            main.title ="Non-spatially Constrained Hierarchical Clustering",
            main.title.size = .7)
...
sk<-qtm(nga_sf_spatialcluster, "SP_CLUSTER")+
   tm_layout(legend.outside = TRUE,
            ...
            legend.position = c("right", "bottom"),
            frame = FALSE,
            main.title ="Non-spatially Constrained Hierarchical Clustering-SKATER",
            main.title.size = .7)
