...
From 4 choropleth maps above, it's clear that spatially constrained clustering of SKATER method relies heaviest on neighboring weights, therefore the delineated districts are quite tidy and congregated. While spatially constrained clustering of ClustGeo method also relies on spatial correlation but no as heavily as SKATER. Clustering of hierarchical based on hclust() and hclustgeo()
